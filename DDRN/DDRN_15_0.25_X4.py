...
class VIDEOSR(object):
    def __init__(self):
        ...
        self.train_dir = './videosr_log/DDRN_15_0.25_X4'
        ...
        for i in range(num_frame):
            ...
            with tf.variable_scope('srmodel', reuse=reuse) as scope_sr:
                with slim.arg_scope([slim.conv2d], activation_fn=prelu , stride=1,
                    ...
                    conv1 = slim.conv2d(conv0, max_feature, [3, 3], scope='enc1')
                    ...
                    for p in range(residual_block):
                        ...
                        with tf.variable_scope('srmodel_block', reuse=reuse_block) as scope_sr_block:
                            ...
                            block_out1 = slim.conv2d(block_out1, max_feature, [1, 1], scope='blockout_{}'.format(p))
